...
class HomePresenter extends ChangeNotifier {
  ...
  fetchAllProducts() async {
    try {
      ...
      // Check if productResponse and its fields are not null
      if (productResponse.products != null && productResponse.meta != null) {
        allProductList.addAll(productResponse.products!);
        totalAllProductData = productResponse.meta!.total;
      } else {
        // Handle the case where products or meta are null
        print("ProductResponse or its fields are null");
      }
